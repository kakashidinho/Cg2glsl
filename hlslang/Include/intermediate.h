...
enum TOperator
{
	...
	EOpConstructMat2FromNonSquareMat,
	EOpConstructMat3FromMat,
	EOpConstructMat3FromNonSquareMat,
...
public:
	...
	TIntermNode() : line(gNullSourceLoc), refCount(1)
	{
	}
...
public:
   ...
   bool isNonSquareMatrix() const { return type.isNonSquareMatrix(); }
...
protected:
	...
	typedef std::vector<Value, pool_allocator<Value> > Values;
	Values values;
};
