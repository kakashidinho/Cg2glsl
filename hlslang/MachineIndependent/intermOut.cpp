...
TString TType::getCompleteString() const
{
   ...
   if (matrix)
      p += sprintf(p, "matrix%dX%d", size, size);
	   ...
	   p += sprintf(p, "matrix%dX%d", getNonSquareColumns(), getNonSquareRows());
   else if (size > 1)
...
bool OutputAggregate(bool, /* preVisit */ TIntermAggregate* node, TIntermTraverser* it)
{
   ...
   case EOpConstructMat2FromNonSquareMat: out.debug << "Construct mat2 from non-square mat"; break;
   case EOpConstructMat3FromMat: out.debug << "Construct mat3 from mat"; break;
   case EOpConstructMat3FromNonSquareMat: out.debug << "Construct mat3 from non-square mat"; break;
